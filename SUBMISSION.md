...
| 10:30 |claude |โปรแกรมพังหลังเปลี่ยนชื่อ ถามว่าเกิดจากอะไร | ได้เข้าใจว่า PHP เก็บ object ลง session แบบ serialize ตัวที่ค้างอยู่จึงยังเป็น property ชื่อเก่า พอโค้ดใหม่เรียกชื่อใหม่จึงได้ null จากนั้นใส่ตัวนับ $dataVersion ใน config.php ให้ล้าง session อัตโนมัติเมื่อโครงข้อมูลเปลี่ยน |
| 11:00 | claude |ไฟล์ใน views  eoror ใน VS Code ถามว่าคืออะไร | Intelephense ฟ้อง undefined variable เพราะ view รับตัวแปรมาทาง include ตัวตรวจอ่านทีละไฟล์เลยไม่รู้ที่มา แก้ด้วยการประกาศ docblock @var ไว้หัวไฟล์ |
| 11:20 | claude | สอบถามการเทส แต่ละเคส เนื่องจาก req มีการบอกว่าถ้าปิดรับแล้วไม่สามารถลงคะแนนได้ ||
